    ...
    public function inserir(Pedido $pedido) {
        try {
            ...
            $sabores = array_filter([
                filter_var($pedido->getSabor1(), FILTER_VALIDATE_INT) ?: null,
                filter_var($pedido->getSabor2(), FILTER_VALIDATE_INT) ?: null,
                filter_var($pedido->getSabor3(), FILTER_VALIDATE_INT) ?: null
            ]);
